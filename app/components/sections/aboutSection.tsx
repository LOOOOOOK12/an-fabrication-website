...
function aboutSection() {
    return (
        <section className='h-screen flex flex-col md:flex-row items-center gap-2 justify-center p-5'>
            <div className='max-w-[1200px] h-[600px] flex flex-col md:flex-row items-center justify-between gap-4'>
                <div className=' flex items-center justify-center'>
                    <CarouselContainer
                        items={AboutCarouselData}
                    />
                </div>
                <div className='max-h-[800px] w-fullflex flex-col gap-2'>
