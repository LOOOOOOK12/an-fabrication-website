...
import { CagesandFencesData, PictureFramesData, CabinetryData, BedsData } from '@/app/types/constants';
import ImageDialog from '@/app/components/imageDialog';

function GallerySection() {
    return (
        <section className="flex flex-col gap-4 items-center justify-center py-20 px-6" id="gallery">
